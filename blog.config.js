...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '3cd6e08868f5493dbf283deb304459bf',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 数字化转型,数智化时代,AI时代', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Human.0: Co-Creating Reality in the Age of AI-Powered Digital World',
